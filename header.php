...
<html <?php language_attributes(); ?>>
    ...
    <body <?php body_class(); ?>>
        <header class="site-header">
            <div class="container">
            <h1 class="school-logo-text float-left"><a href="<?php echo site_url() ?>"><strong>Uni</strong> Project</a></h1>
            ...
            <div class="site-header__menu group">
                ...
                <ul>
                    ...
                    <li <?php if (get_post_type() == 'eventy' OR is_page('past-events')) echo 'class="current-menu-item"' ?>><a href="<?php echo get_post_type_archive_link('eventy'); ?>">Events</a></li>
